...
export default function ModeToggle() {
    ...
    useEffect(() => { setDarkMode(document.documentElement.getAttribute("mode") === "dark") })
    ...
    return (
        <button className="theme-toggle" onClick={() => { handleClick(); toggleDarkMode(); }}>
            <animated.svg
...
function handleClick() {
    if (document) {
        ...
        root.classList.add("toggle-mode");
    }
}